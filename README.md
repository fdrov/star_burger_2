...
Для работы Яндекс-геокодера нужен токен. Получить его можно в [кабинете разработчика](https://developer.tech.yandex.ru/).

Поместите токен в переменные окружения.
